    ...
    return (
        <>
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-16'>
                <div className="md:w-1/2 order-2 md:order-1 w-full mt-12 md:mt-32">
                    <div className='space-y-12'>
                        ...
                        <p className='text-xl '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat, blanditiis quasi. Architecto quis quidem nemo rerum adipisci, iure laudantium quo velit ex eius iusto, pariatur sequi, dolores eveniet odit cupiditate.
                        </p>
